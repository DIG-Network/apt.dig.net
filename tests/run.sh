...
rc=0
for t in test_version_resolution.sh test_catalogue_coverage.sh test_build_paths.sh test_deploy_triggers.sh test_dig_node_port.sh test_deb_layout.sh test_repo_metadata.sh test_site_baseline.sh test_version_injection.sh; do
  printf '\n========== %s ==========\n' "$t"
